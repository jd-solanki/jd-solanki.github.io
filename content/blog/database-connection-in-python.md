...
description: Learn how to connect to a database in Python using different methods including sqlite3 and SQLAlchemy with context managers.
---
...
::accordion-item{label="Class based Context Manager" icon="i-lucide-code"}
